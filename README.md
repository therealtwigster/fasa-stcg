...
> **Build v1.30-S41** · 2026-08-22 19:30 UTC
...
## Klingon Fleet Expansion (v1.30-S41)

Five new **playable Klingon hulls**, cleaned from scanned FASA ship counters and statted from the
Klingon Ship Recognition Manual (FASA 2301):

- **D-2 Stingtongue** (Class VI Destroyer) — the "missile boat"; twin KD-6 disruptors fore/aft plus four KP-2 torpedo tubes split fore and aft.
- **T-5 Throne Seeker** (Class VII Assault Ship) — six KD-1 disruptors across the wings and aft.
- **L-24 Ever-Victorious** (Class XIII Battleship) — the "Queen of Battle"; sixteen weapons (eight forward KD-8, four aft KD-13, four KP-6 torpedoes). Shares the Throne Seeker's counter art (near-identical hull).
- **D-18C Gull** (Class IX Destroyer) — gull-wing hull, **cloak-capable** (KCC/32); six KD-5 forward, aft KD-14 + KP-5.
- **L-9 Saber** (Class X Frigate) — the "fast-sword"; six KD-8 + four KD-13 disruptors.

All five appear in the Klingon ship selector. Power (warp+impulse) matches each hull's FASA total power exactly.
